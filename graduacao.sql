...
(51, '3.10', 'Atividades de promoção da cidadania (promoção da igualdade étnica-racial, educação ambiental, direit', 10, 2, 3);
...
(9, 'WOPI - III Workshop de Pesquisa em Informática', '2013-09-12', '2013-09-13', 14, 0, '', 'Submetida', 43, 2, 30, 0, 0, NULL, 'certificadosWOPI-2013.170.pdf', '30_800116.pdf', '2016-08-03'),
...
(11, 'SEMINFO - Semana de Informática', '2013-06-12', '2013-06-14', 20, 0, '', 'Submetida', 44, 2, 30, 0, 0, NULL, 'voluntarios_seminfo.pdf', '30_877314.pdf', '2016-08-03'),
(12, 'CETELI - Programa de Formação Complementar "Tecnologias para dispositivos móveis"', '2014-05-01', '2014-08-31', 60, 0, '80 horas são referentes à formação teórica ministrada', 'Submetida', 40, 2, 30, 0, 0, '', NULL, NULL, '2016-08-03'),
(13, 'CETELI - Programa de Formação Complementar "Tecnologias para dispositivos móveis"', '2014-09-01', '2014-12-31', 60, 0, 'Ao total são 100 horas referentes ao desenvolvimento de projeto de aplicativo', 'Submetida', 50, 2, 30, 0, 0, NULL, '2016-08-02 22.26.52.jpg', '30_323627.jpg', '2016-08-03'),
(14, 'PRODAM - Visita Técnica', '2012-05-03', '2012-05-04', 4, 0, '', 'Submetida', 42, 2, 30, 0, 0, NULL, '2016-08-02 23.00.00.jpg', '30_255870.jpg', '2016-08-03'),
...
(21, 'Certificado de Conclusão de Curso de Inglês', '2013-08-03', '2014-12-13', 60, 0, '', 'Submetida', 33, 2, 36, 0, 0, '', 'New Doc_1.pdf', '36_978029.pdf', '2016-08-03'),
...
(48, 'Certificado de Participação do PIBIC 2014/2015', '2014-08-01', '2015-07-31', 60, NULL, '', 'Submetida', 38, 2, 36, 0, 0, NULL, 'pesquisa_60h_pibic.pdf', '36_456217.pdf', '2016-10-27'),
(24, 'Certificado de Participação AASSQ 2015', '2015-08-17', '2015-08-21', 20, 0, '', 'Submetida', 43, 2, 36, 0, 0, '', 'v0_CERTIFICADO_Leandro.pdf', '36_44901.pdf', '2016-08-03'),
(46, 'Carga horária optativa excedente', '2016-10-26', '2016-10-26', 60, NULL, 'Possuo 210h de carga horária optativa excedente, devido à mudanças na grade curricular do curso.', 'Submetida', 30, 2, 37, 0, 0, NULL, 'HISTÓRICO ESCOLAR - VICTOR VALENTE - 21002593.pdf', '37_676825.pdf', '2016-10-26'),
(26, 'Certificado de participação no Hackathon do II EPA (3º lugar).', '2015-04-29', '2015-04-30', 12, 0, '', 'Submetida', 45, 2, 37, 0, 0, NULL, 'Certificados_Hackathon_Victor.pdf', '37_652442.pdf', '2016-08-05'),
(27, 'Certificado de participação no EPA 2015', '2015-04-29', '2015-04-30', 16, 0, '', 'Submetida', 43, 2, 37, 0, 0, NULL, 'CERTIFICADO EPA II.pdf', '37_843344.pdf', '2016-08-05'),
(28, 'Certificado de participação do curso Introdução ao Android oferecido pelo OCEAN - Samsung', '2014-11-18', '2014-11-18', 4, 0, '', 'Submetida', 31, 2, 37, 0, 0, NULL, 'CERTIFICADO INTRO AO ANDROID OCEAN.pdf', '37_946015.pdf', '2016-08-05'),
(29, 'Certificado de participação no WoPI II (2012)', '2012-11-12', '2012-11-13', 16, 0, '', 'Submetida', 31, 2, 37, 0, 0, NULL, 'CERTIFICADO WOPI 2012.pdf', '37_10152.pdf', '2016-08-05'),
(30, 'Certificado de participação na SEMINFO 2013', '2013-06-12', '2013-06-14', 4, 0, '', 'Submetida', 43, 2, 37, 0, 0, NULL, 'CERTIFICADO SEMINFO 2013.pdf', '37_441100.pdf', '2016-08-05'),
(31, 'Certificado de participação no curso de SCRUM da SEMINFO 2013', '2013-06-12', '2013-06-14', 4, 0, '', 'Submetida', 31, 2, 37, 0, 0, NULL, 'CERTIFICADO SCRUM SEMINFO 2013.pdf', '37_508061.pdf', '2016-08-05'),
(33, 'Participação do experimento “Reconhecimento de Engajamento em sessões de vídeos"', '2016-06-20', '2016-06-21', 3, 0, '', 'Submetida', 40, 2, 25, 0, 0, '', 'Cristhian Giovanni Lopes de Oliveira.pdf', '25_50139.pdf', '2016-09-08'),
(34, 'Certificado de Desenvolvedor de soluções Microsoft: Windows Store Apps Using C#', '2015-12-03', '2015-12-04', 2, 0, '', 'Submetida', 31, 2, 25, 0, 0, NULL, 'Certificate_1.pdf', '25_605645.pdf', '2016-09-08'),
(35, 'Certificação Especialista Microsoft: Programando em C#', '2015-05-03', '2015-05-04', 2, 0, '', 'Submetida', 31, 2, 25, 0, 0, NULL, 'Certificate_2.pdf', '25_33900.pdf', '2016-09-08'),
(36, 'Certificação Profissional Microsoft ', '2015-11-02', '2015-11-03', 2, 0, '', 'Submetida', 31, 2, 25, 0, 0, NULL, 'Certificate_3.pdf', '25_687521.pdf', '2016-09-08'),
(37, 'Participação na defesa: "Detecção de Elementos Antrópicos em Imagens da Floresta Amazônica”.', '2016-07-01', '2016-07-02', 2, 0, 'Defesa de tese de mestrado do disccente  Luiz Carlos', 'Submetida', 47, 2, 25, 0, 0, '', NULL, NULL, '2016-09-08'),
(38, 'Curso FGV Online - Fundamentos da Gestão de TI', '2016-07-29', '2016-07-30', 5, 0, '', 'Submetida', 31, 2, 31, 0, 0, '', 'FundGestao_certificado_Fgv.pdf', '31_889725.pdf', '2016-09-13'),
(39, 'Curso FGV Online - Ciência e Tecnologia', '2016-07-29', '2016-07-30', 15, 0, '', 'Submetida', 31, 2, 31, 0, 0, NULL, 'CienciaTecnologia_certificado_Fgv.pdf', '31_946794.pdf', '2016-09-13'),
...
(47, 'Certificado de Monitoria', '2014-04-01', '2014-09-30', 60, NULL, '', 'Submetida', 29, 2, 36, 0, 0, '', 'ensino_60h_monitoria.pdf', '36_357891.pdf', '2016-10-27'),
...
(63, 'OCEAN Capacitação para Desenvolvimento de Aplicações Móveis: Turma Fechada de Jogos Digitais', '2015-07-03', '2015-12-16', 200, NULL, 'Conferida pela Universidade do Estado do Amazonas em parceria com a Samsung Ocean Center', 'Submetida', 31, 2, 43, 0, 0, NULL, 'Ocean.pdf', '43_505484.pdf', '2016-11-03'),
(64, 'Divus Curso Academia do Programador ', '2014-08-18', '2014-10-22', 80, NULL, 'Certificado por Divus Tecnologia - Treinamento e Desenvolvimento de Software', 'Submetida', 31, 2, 43, 0, 0, NULL, 'DivusAcademiaProgramador.pdf', '43_234562.pdf', '2016-11-03'),
(65, 'Resenha ASIMOV, Isaac. Eu, Robô: 2 Cap Brincadeira de Pegar. 1950.', '2016-05-25', '2016-05-29', 1, NULL, 'Exercício introspectivo e individual realizado na matéria de Inteligência Artificial ', 'Submetida', 49, 2, 43, 0, 0, '', 'Lukas21204522ResenhaEuRobo.pdf', '43_954399.pdf', '2016-11-03'),
(66, 'Resenha do Filme: Spare Parts NCNAMARA, Sean. Spare Parts. 2015. ', '2016-09-11', '2016-09-11', 1, NULL, 'Resenha para a Disciplina de Inteligência Artificial com o professor Alberto', 'Submetida', 49, 2, 43, 0, 0, NULL, 'Lukas21204522-ResenhaSpareParts.pdf', '43_999655.pdf', '2016-11-04'),
...
(90, 'Certificado de conclusão de curso pré-avançado de língua Inglesa', '2013-01-25', '2013-06-25', 60, NULL, '', 'Submetida', 33, 2, 25, 0, 0, NULL, 'new doc 520161107224128151.pdf', '25_90681.pdf', '2016-11-10'),
...
(91, 'Projeto de Banco de Dados da Assessoria de Relação Internacional e Interestitucional - Reitoria Ufam', '2014-09-01', '2015-02-27', 60, NULL, 'UFAM-Reitoria-ARII - Assessoria de Relação Internacional e Interestitucional ', 'Aberto', 40, 2, 56, 0, 0, NULL, 'Certificado do Jhon_ARII.pdf', '56_749161.pdf', '2016-11-13'),
(92, 'Participação como voluntário no Projeto de Pesquisa "Curupirapp-Disseminação de Conteúdo Multimídia"', '2015-05-27', '2015-05-27', 5, NULL, 'Voluntário ao instalar e fornecer dados de mobilidade de dispositivo móvel através do APP FeriadoBr', 'Submetida', 38, 2, 43, 0, 0, NULL, 'certificado (2).pdf', '43_604594.pdf', '2016-11-14'),
...
(103, 'Participação no projeto "Sistema de Gestão de Projetos de Extensão"', '2013-11-10', '2014-11-10', 480, NULL, '', 'Submetida', 40, 2, 105, 0, 0, NULL, 'New Doc 1.pdf', '105_879801.pdf', '2016-11-22'),
(104, 'Participação em PIBIC', '2011-08-01', '2012-07-31', 480, NULL, '', 'Submetida', 38, 2, 105, 0, 0, NULL, 'New Doc 2.pdf', '105_44662.pdf', '2016-11-22'),
(105, 'Participação em PIBIC', '2012-08-01', '2013-07-31', 480, NULL, '', 'Submetida', 38, 2, 105, 0, 0, NULL, 'New Doc 3.pdf', '105_230771.pdf', '2016-11-22'),
(106, 'Apresentação de artigo', '2012-11-19', '2012-11-22', 30, NULL, '', 'Submetida', 34, 2, 105, 0, 0, NULL, 'New Doc 5.pdf', '105_307093.pdf', '2016-11-22'),
...
--
-- Estrutura da tabela `tbl_dynagrid`
--
...
--
-- Estrutura da tabela `tbl_dynagrid_dtl`
--
...
(27, 'ADIEL WESLEY BEZERRA DA SILVA', '025.566.552-08', 'awbs@icomp.ufam.edu.br', '9fcda186b43fcee6219304b6d18a4035', '21456803', NULL, 'Aluno', NULL, 0, 1, NULL, NULL, 2, '', '', ''),
...
--
-- Limitadores para a tabela `tbl_dynagrid`
--
